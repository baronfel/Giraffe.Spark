...
[<assembly: AssemblyTitleAttribute("Giraffe.Spark.Tests")>]
[<assembly: AssemblyProductAttribute("Giraffe.Spark")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Giraffe.Spark.Tests"
    let [<Literal>] AssemblyProduct = "Giraffe.Spark"
